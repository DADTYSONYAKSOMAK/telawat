...
def msgs(message):
    ...
    if text == "تلاو" or text == "تلاوات" or text == "تلاوة":
        voice_url = "https://t.me/CV_T79/" + str(random.randint(7, 276))
        bot.send_voice(message.chat.id, voice_url, caption="« صلي على سيدنا محمد ﷺ »", reply_to_message_id=message.message_id, reply_markup=telebot.types.InlineKeyboardMarkup().row(
            telebot.types.InlineKeyboardButton(text='✧ - المطور 🌐', url='https://t.me/S_Ml10'),
            telebot.types.InlineKeyboardButton(text='✧ - قناة التحديثات', url='https://t.me/S_Ml18')))

print("تم تشغيل البوت لو وقف شي كلمني @S_Ml10!")
bot.polling()
...
#مطور الملف @S_Ml10
#جميع الحقوق محفوظه لسورس ايثون